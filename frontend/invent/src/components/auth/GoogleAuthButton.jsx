 ...
 *
 * Initiates Google OAuth via a full-page redirect to the backend.
 * Handles 429 rate-limit gracefully before redirecting.
 *
 * Props:
 *   label    — button text (default "Continue with Google")
 *   onError  — callback(message) called when rate-limited or network fails
